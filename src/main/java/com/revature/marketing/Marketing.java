...
public class Marketing {
    ...
    public Marketing(Integer marketingId, String productCategory, Integer qty, Timestamp orderDate, String country, String city, Integer timeOfDay, Integer months) {
